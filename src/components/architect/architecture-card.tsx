...
const AI_ARCH_META = {
  pattern: {
    ...
    calculation: "Recommended from the full submission, readiness gaps, and telecom context.",
  },
  confidence: {
    meaning: ARCHITECT_FIELD_META["architecture.confidence"].meaning,
    calculation: "Confidence score (1–100) based on fit between use case and recommended pattern.",
  },
  rationale: {
    meaning: ARCHITECT_FIELD_META["architecture.rationale"].meaning,
    calculation: "Grounded in submitted content and assessment dimensions.",
  },
  technologies: {
    meaning: ARCHITECT_FIELD_META["architecture.technologies"].meaning,
    calculation: "Aligned to CGI's Microsoft-centric telecom practice.",
  },
};
...
export function ArchitectureCard({
  ...
  const meta = source === "openai" ? AI_ARCH_META : ARCHITECT_FIELD_META;
